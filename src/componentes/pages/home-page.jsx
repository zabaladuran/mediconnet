...
function HomePage() {
  const { credenciales, cerrarSesion, cargando } = useAut();
        ...
        <>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-300 mt-4">
                Servicios médicos a domicilio 24/7 en Bucaramanga, Cúcuta y
                Santa Marta
              </p>
          ...
          <div id="servicios" className="bg-gray-100 py-12">
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <ServiceCard
                icon={
                  <Baby className="text-[#16a34a] w-10 h-10 mb-2 mx-auto" />
                }
            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-1/2">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  compromiso humano y cobertura nacional nos hacen líderes en
                  salud.
                </p>
          ...
          <div className="bg-gray-100 py-16">
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
              <ServiceCard
                icon={
                  <Globe className="text-[#16a34a] w-10 h-10 mb-2 mx-auto" />
                }
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Comunícate con nosotros para recibir atención médica en casa, las
              24 horas.
            </p>
            <ul className="flex flex-col md:flex-row justify-center gap-4 mb-6 text-[#16a34a] font-medium">
              ...
              <li className="flex items-center gap-2">
                <i className="fas fa-shield-heart"></i> Confidencialidad y
                seguridad
              </li>
            </ul>
                ...
                <div className="flex flex-col md:flex-row md:space-x-8 space-y-6 md:space-y-0">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700 text-sm">
                      ...
                      <br />
                      <span>
                        <strong>Emergencias:</strong> PBX: (605) 4237201 Opción
                        1
                      </span>
                      <br />
                      <span>
