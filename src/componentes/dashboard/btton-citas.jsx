        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="border-b pb-2">
              ...
              <p className="text-sm text-gray-500">Medicina General - Consulta Regular</p>
            </div>
            <div className="border-b pb-2">
              <p className="text-sm font-medium">11:45 - Dra. Rodríguez López</p>
              <p className="text-sm text-gray-500">Consultorio 205</p>
              <p className="text-sm text-gray-500">Cardiología - Control Rutinaro</p>
            </div>
            <div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center border-b pb-2">
            <div>
              ...
              <p className="text-sm text-gray-500">Dr. García Martínez - Medicina General</p>
            </div>
          ...
          <div className="flex justify-between items-center border-b pb-2">
            <div>
              ...
              <p className="text-sm text-gray-500">Dra. Rodríguez López - Cardiología</p>
            </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-500">Dr. Sánchez Pérez - Traumatología</p>
            </div>
