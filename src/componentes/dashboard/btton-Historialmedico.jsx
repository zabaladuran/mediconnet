        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 text-sm">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-2 mt-1">
              <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-xs">Penicilina</span>
              <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-xs">Aspirina</span>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-500">Dra. García - Chequeo general</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-500">Última actualización: 10/11/2023</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-500">Gráfico de ejemplo (inserta tu componente aquí)</p>
            <div className="bg-gray-100 h-32 flex items-center justify-center text-gray-400">[Gráfico]</div>
          </CardContent>
        </Card>
